...
def calculate_demographic_data(print_data=True):
    ...
    proportion_bachelors = df['education'].value_counts(normalize=True)['Bachelors']
    percentage_bachelors = round(100 * proportion_bachelors, 1)
    ...
    highest_earning_country_percentage = round(
      (df.loc[df['salary'] == '>50K', 'native-country'].value_counts() / df['native-country'].value_counts())[highest_earning_country] * 100,
      1
    )
